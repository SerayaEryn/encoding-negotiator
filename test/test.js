...
test('Should return "br" for "gzip, deflate, br" and ["br", "gzip", "deflate"] and prefferedEncoding=br', (t) => {
  const header = 'gzip, deflate, br'
  const supportedEncodings = ['br', 'gzip', 'deflate']

  const result = enodingNegotiator.negotiate({ header, supportedEncodings, prefferedEncoding: 'br' })

  t.is(result, 'br')
})

test('Should return "gzip" for "gzip, deflate, br" and ["br", "gzip", "deflate"] and prefferedEncoding=undefined', (t) => {
  const header = 'gzip, deflate, br'
  const supportedEncodings = ['br', 'gzip', 'deflate']
...
test('Should return "br" for "*" and ["br", "gzip", "deflate"] and prefferedEncoding=br', (t) => {
  const header = '*'
  const supportedEncodings = ['br', 'gzip', 'deflate']
